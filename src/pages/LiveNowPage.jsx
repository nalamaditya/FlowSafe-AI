        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] sm:text-xs text-slate-500 font-medium">{activeEnv.description}</p>
            </div>
          </div>

          <span className="text-[10px] sm:text-xs font-bold px-2.5 sm:px-3 py-1 rounded-full bg-blue-50 text-blue-700 border border-blue-200 font-mono self-start sm:self-auto shrink-0">
            {activeEnv.locations?.length} Monitored Zones
          </span>
        </div>

        {/* Environment Filter Buttons with Smooth Touch Scroll */}
